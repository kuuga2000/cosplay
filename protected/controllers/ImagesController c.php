	...
	public function actionCreate() {
		...
		if (isset($_POST['Image'])) {
			...
			if ($model -> save()) {
				...
				copy(Yii::app() -> basePath . self::URLUPLOAD . $model -> image_content, Yii::app() -> basePath . self::URLUPLOAD . '/thumbs/' . $file);
				echo $file_name = Yii::app() -> basePath . self::URLUPLOAD . 'thumbs/' . $file;

				$image = Yii::app() -> image -> load($file_name);
				//315x177.jpg
				//$image->crop(50,50,20,0);
				$image -> resize(50, 0);
