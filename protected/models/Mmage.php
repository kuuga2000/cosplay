 ...
 */
class Mmage extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('image_title, image_description, gallery_id', 'required'),
			
			array('image_content', 'file', 'types'=>'jpg, gif, png','allowEmpty'=>TRUE),
	 ...
	 * @return Mmage the static model class
	 */
