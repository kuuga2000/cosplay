...
<div class="main-column-wrapper">
	...
	<div class="main-column-left">
		...
		<div class="post post-style-2">
			<h2 class="article-title"><a href="#"><?=$model['news_title'];?></a></h2>
			
			<div class="info">
				<span class="date"><?=$model['news_postdate'];?></span>
				 
			</div>
			
			 <? if(!empty($model['news_video'])){?>	
			<center>
			<iframe width="440" height="335" src="//www.youtube.com/embed/<?=$model['news_video'];?>" frameborder="0" allowfullscreen></iframe>
			</center>
			<? } ?>
			<?=str_replace('<img src="http://pixel.quantserve.com/pixel/p-89EKCgBk8MZdE.gif" border="0" height="1" width="1" />', '',nl2br($model['news_content']));?>
		...
		<div class="comments">
			...
			<div class="fb-comments" data-href="<?=Yii::app() -> request -> baseUrl;?>/news/<?=$model['id'];?>/<?=str_replace(' ', '-', $model['news_title']);?>.html" data-width="580"></div><!--w470-->
			<!--facebook-->
			<!-- END .comments -->
		</div>
